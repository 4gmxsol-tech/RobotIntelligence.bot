...
async function rdap(domain){return {connector:"rdap",status:"simulated",domain,evidence:[normalizeEvidence({type:"domain_structure",source:"local-domain-record",confidence:"low",supports:["domain format"]})]};}
